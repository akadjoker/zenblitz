...
For degrees=0 To 359
	...
	; Calculate the mathematical Y co-ordinate of the point of the circle using Sin
	; but adding 180 to the angle, and multiply it by 100 (to get a larger radius, try and change it)
