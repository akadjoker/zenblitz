...
Const width=640,height=480,num_rots=64
...
SetFont LoadFont( "helvetica",16,True )
...
Function LoadGraphics()
	...
	player_image=LoadImage( "graphics\player.bmp" );:ScaleImage player_image,.75,.75
	mini_ship=CopyImage( player_image ):ScaleImage mini_ship,.4,.4
	bull_image=LoadImage( "graphics\bullet.bmp" ):ScaleImage bull_image,.75,1
	bomb_image=LoadImage( "graphics\bbomb.bmp" ):ScaleImage bomb_image,.5,.5
	boom_anim=LoadAnimImage( "graphics\kaboom.bmp",60,48,0,6 )
	insectoids_image=LoadImage( "graphics\insectoids_logo.bmp" )
	ResizeImage boom_anim,32,32:ResizeImage boom_anim,56,56
	i=LoadImage( "graphics\alien.bmp" ):ScaleImage i,.65,.65
