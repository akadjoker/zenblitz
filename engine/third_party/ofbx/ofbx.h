...
struct Texture : Object
{
	...
	// Raw bytes of the FBX "Video" object this texture's "Media" connects
	// to, if the exporter embedded the image straight in the file (an
	// "Embed Media" export) instead of shipping it as a sibling file. Empty
	// (begin == nullptr) when there is no such connection.
