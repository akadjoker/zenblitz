 ...
 *
 * --------------------------------------------------------------------
 * Adapted: fdi.h's pluggable allocator (FDI_Int/HFDI, only ever wired to
 * HeapAlloc/HeapFree here) is gone - fdi_Ziphuft_free and the two
 * allocation sites in fdi_Ziphuft_build call malloc/free directly. See
 * VERSION.
 */

#include "xfile_mszip.h"
 ...
 */
static void fdi_Ziphuft_free(struct Ziphuft *t)
{
