...
const float BLITZ_INFINITY=10000000.0f;	//big value (INFINITY is a <math.h> macro)
...
public:
	Vector a,b;
	Box():a( Vector(BLITZ_INFINITY,BLITZ_INFINITY,BLITZ_INFINITY) ),b( Vector(-BLITZ_INFINITY,-BLITZ_INFINITY,-BLITZ_INFINITY) ){
	}
	...
	void clear(){
		a.x=a.y=a.z=BLITZ_INFINITY;
		b.x=b.y=b.z=-BLITZ_INFINITY;
	}
	bool empty()const{
