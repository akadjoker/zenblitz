...
namespace engine
{
    ...
    bool Collision::sphereCollide(const Line &line, float radius, const Vector &dest, float destRadius)
    {
        radius += destRadius;
    ...
    static bool edgeTest(const Vector &v0, const Vector &v1, const Vector &pn, const Vector &en,
                          const Line &line, float radius, Collision *curr)
    {
        blitz::Matrix tm = ~blitz::Matrix(en, (v1 - v0).normalized(), pn);
                                     ...
                                     bool facesOnly)
    {
        ...
        blitz::Plane p0(v0 + p.n, v1, v0), p1(v1 + p.n, v2, v1), p2(v2 + p.n, v0, v2);
        ...
        bool c = edgeTest(v2, v0, p.n, p2.n, line, radius, this);
        return a | b | c;
    }
    ...
    bool Collision::boxCollide(const Line &line, float radius, const Box &box)
    {
        ...
        {
            Vector v0(box.corner(quads[n])), v1(box.corner(quads[n + 1])),
                v2(box.corner(quads[n + 2])), v3(box.corner(quads[n + 3]));
            ...
            blitz::Plane p0(v0 + p.n, v1, v0), p1(v1 + p.n, v2, v1),
                p2(v2 + p.n, v3, v2), p3(v3 + p.n, v0, v3);
            ...
            hit |= edgeTest(v0, v1, p.n, p0.n, line, radius, this);
            hit |= edgeTest(v1, v2, p.n, p1.n, line, radius, this);
            hit |= edgeTest(v2, v3, p.n, p2.n, line, radius, this);
            hit |= edgeTest(v3, v0, p.n, p3.n, line, radius, this);
        }
        return hit;
    }
}
